layui.define(function(exports) {
    ...
    layui.use(['table', 'layer', 'jquery', 'form'], function () {
        ...
        //监听工具条(删除)
        table.on('tool(specialtyTab)', function (obj) {
        ...
        //新增顶级菜单点击
        $("body").on("click", "#specialtyBtn", function () {
            add();
        })
            ...
            layer.open({
                ...
                yes: function(index, layero){
                    let iframeWindow = window['layui-layer-iframe'+ index]
                        ,submit = layero.find('iframe').contents().find("#faculty-edit-submit");
                    //监听提交
                    iframeWindow.layui.form.on('submit(faculty-edit-submit)', function(data){
